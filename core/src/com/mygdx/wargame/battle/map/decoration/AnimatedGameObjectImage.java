...
public class AnimatedGameObjectImage extends Image implements Tree {
    ...
    public AnimatedGameObjectImage(TextureRegion texture, float speed, int idle) {
    ...
    public AnimatedGameObjectImage(TextureRegion texture, float speed, int idle, float rotation) {
        this(texture, speed, idle);
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        batch.draw(textureRegion, getX(), getY(), 0.5f, 0.5f, 1f, 1f, 1f, 1f, rotation);
